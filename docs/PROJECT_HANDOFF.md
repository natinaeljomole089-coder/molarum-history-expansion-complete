...
Molarum is an offline-first Grade 10 revision library for Android. It bundles validated questions, keeps learner progress on-device, supports resumable practice, and presents a premium dark student experience. The current catalog is **1,840 questions across 46 units**.
...
> **History status:** The owner-approved History textbook is available. History Unit 1 is bundled; Units 2–6 remain source-bounded continuation work rather than unsupported placeholder content.

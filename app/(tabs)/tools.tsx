...
const TOOL_LINKS = [
  { title: "Account & sync", detail: "Optional sign-in, private learner-record sync, and teacher cloud publishing.", route: "/cloud" },

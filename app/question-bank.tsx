...
export default function QuestionBankScreen() {
  ...
  const reset = () => Alert.alert("Restore bundled content?", "This removes a locally imported override and review states, then restores the 920-question source-grounded bank packaged with Molarum.", [{ text: "Cancel", style: "cancel" }, { text: "Restore", style: "destructive", onPress: resetToBundledContent }]);

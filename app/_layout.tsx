...
export default function RootLayout() {
  ...
  const content = <GestureHandlerRootView style={{ flex: 1 }}><trpc.Provider client={trpcClient} queryClient={queryClient}><QueryClientProvider client={queryClient}><StudyLibraryProvider><Stack screenOptions={{ headerShown: false }}><Stack.Screen name="(tabs)" /><Stack.Screen name="subject/[subjectId]" /><Stack.Screen name="unit/[unitKey]" /><Stack.Screen name="quiz/[unitKey]" /><Stack.Screen name="results/[attemptId]" /></Stack><StatusBar style="light" /></StudyLibraryProvider></QueryClientProvider></trpc.Provider></GestureHandlerRootView>;

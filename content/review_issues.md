...
Molarum now bundles a **1,960-question source-grounded bank across 49 complete units** from owner-approved materials. It contains six units each for Chemistry, Physics, and Biology; all seven Mathematics units; all eight Geography units; all eight Citizenship units; Units 1–3 for Economics; Unit 1 for Health & PE; and Units 1–4 for History. Each completed unit passed Molarum’s structural validator: 40 questions per unit with 20 multiple choice, 4 true/false, 8 short answer, 8 numerical, and the required 14 easy, 18 medium, and 8 hard labels.
...
| History | 4 | 160 | Structurally validated; Units 1–4 were added from the owner-approved textbook. Units 5–6 remain source-bounded continuation work. |
...
History Units 5–6, Economics Units 4–8, and Health & PE Units 2–8 remain unresolved until a specific owner-approved text boundary is prepared and a complete source-bounded batch passes validation for each unit.
